...
# end = false
# while not end(message)
#   pick source
#   choose from source
#   if no choice
#     choice = choose random new head
#   message << choice
#   head = choice

 
# a head is a start of a sentence, and a tail is any word that follows
# that head in the given sample text.
class Markov
    END_MARKS = [".", "?", "!"]
    CAPS = "A".."Z"
